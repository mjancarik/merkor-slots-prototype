...
const expressStaticConfig = { enableBrotli: true, index: false, orderPreference: ['br'], maxAge: '14d' };
...
app
  ...
  .use(cors())
  .use(compression())
  .use('/static', expressStaticGzip(path.join(__dirname, 'static'), expressStaticConfig))
  .use('/static', expressStaticGzip(path.join(__dirname, '../build/static'), expressStaticConfig))
  .use(
    '/@merkur/tools/static/',
